---
title: "Python random : 의사 난수, 시드 고정하기"
...
# [Python random : 의사 난수, 시드 고정하기](https://velog.io/@bluepaper14_/%ED%8C%8C%EC%9D%B4%EC%8D%AC-random%EC%9D%80-%EC%A7%84%EC%A7%9C-%EB%AC%B4%EC%9E%91%EC%9C%84%EC%9D%BC%EA%B9%8C)
...
> 의사 난수 : 컴퓨터가 수학적 알고리즘을 이용해 생성한 난수로, 무작위처럼 보이지만 동일한 초기값(seed)에서는 항상 같은 순서로
> 반복되는 수.
